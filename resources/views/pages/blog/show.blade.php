...
@section('content')
     ...
     <section class="details-banner">
        <img src="{{ asset('front/dist/images/detailsbanner.jpg') }}" alt="Background Image" class="img-fluid w-100">
    </section>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-lg-10">
                            <div class="blog-article-end">
                                ...
                                <img src="{{ asset('front/dist/images/blogd01.jpg') }}" alt="Image" class="img-fluid">
                                <p>
                                ...
                                <img src="{{ asset('front/dist/images/blogd02.jpg') }}" alt="Image" class="img-fluid">
                                <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="blog-item">
                        <div class="blog-item-image">
                            <a href="details.html">
                                <img src="{{ asset('front/dist/images/05.jpg') }}" alt="Image">
                            </a>
                        </div>
                        <div class="blog-item-info">
                            <span class="fs-6 has-line">Travels</span>
                            ...
                            <div class="comments-owner">
                                <div class="comments-owner-image">
                                    <a href="#" class="d-block">
                                        <img src="{{ asset('front/dist/images/cowner.png') }}" alt="Image">
                                    </a>
                                </div>
